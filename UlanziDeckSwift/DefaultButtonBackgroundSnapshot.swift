...
nonisolated enum DefaultButtonBackgroundSnapshot {
    ...
    private static func sourceAssetName(for function: DeckKeyFunction) -> String? {
        ...
        case .none, .tally, .openFile, .openWebPage, .brightness, .sub2API, .sub2APIBalance, .sub2APIDailyCost, .newAPIModelAvailability, .pageFolder, .pageBack, .previousPage, .nextPage:
            return nil
        }
    }
    ...
    private static func systemSymbolName(for function: DeckKeyFunction) -> String? {
        ...
        case .none, .tally, .openFolder, .openFile, .connectSMBServer, .brightness, .sub2API, .sub2APIBalance, .sub2APIDailyCost, .newAPIModelAvailability, .codexUsage, .genshinStatus, .starRailStatus, .zenlessZoneStatus:
            return nil
        }
    }
...
extension DeckKeyConfiguration {
    nonisolated mutating func refreshDefaultButtonBackgroundSnapshot() {
        ...
        case .previousPage, .nextPage:
            visual.replaceBackground(with: defaultVisual)
        case .none, .tally, .openFile, .brightness, .sub2API, .sub2APIBalance, .sub2APIDailyCost, .newAPIModelAvailability:
            break
        }
